...
c(
  harrypotter::harrypotter(10, option = "ravenclaw")
  , harrypotter::harrypotter(10, option = "ravenclaw2")
  , harrypotter::harrypotter(10, option = "gryffindor")
  , harrypotter::harrypotter(10, option = "gryffindor2")
  , harrypotter::harrypotter(10, option = "hufflepuff")
  , harrypotter::harrypotter(10, option = "slytherin")
  , harrypotter::harrypotter(10, option = "hermionegranger")
  , harrypotter::harrypotter(10, option = "harrypotter")
  , harrypotter::harrypotter(10, option = "dracomalfoy")
  , harrypotter::harrypotter(10, option = "newtscamander")
  , harrypotter::harrypotter(10, option = "lunalovegood")
  , harrypotter::harrypotter(10, option = "ronweasley")
  , harrypotter::harrypotter(10, option = "ronweasley2")
  , harrypotter::harrypotter(10, option = "mischief")
  , harrypotter::harrypotter(10, option = "sprout")
  , harrypotter::harrypotter(10, option = "always")
) %>%
  # sample() %>%
  # .[1:length(unique(ttops_temp$dbscan_cluster))-1] %>% 
  scales::show_col(labels = F, ncol = 10)
```
...
plt_grps_temp = ortho_plt_fn(100) +
    ...
    harrypotter::scale_color_hp_d("newtscamander") +
    labs(color = "") +
    theme(legend.key = element_rect(color = NA, fill = NA), legend.margin = margin(6.5,0,6.5,0)) +
    guides(size = "none", color = guide_legend(override.aes = list(size = 5)))
